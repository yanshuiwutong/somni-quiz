...
def test_content_branch_applies_llm_answer_when_emotion_tail_is_orphaned() -> None:
    question_catalog = {
    ...
    graph_state = create_graph_state(
        session_id="session-branch-answer-plus-emotion-tail",
        channel="grpc",
        quiz_mode="dynamic",
        question_catalog=question_catalog,
        language_preference="zh-CN",
    ...
    assert result["applied_question_ids"] == ["question-01"]
