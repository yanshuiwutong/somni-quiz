...
def test_content_understand_companion_followup_selector_does_not_bind_current_question() -> None:
    question_catalog = {
        "question_order": ["question-01"],
        "question_index": {"question-01": _age_question()},
    }
    graph_state = create_graph_state(
        session_id="session-selector-companion-guard",
        channel="grpc",
        quiz_mode="dynamic",
        question_catalog=question_catalog,
        language_preference="zh-CN",
    ...
    graph_state["session_memory"]["pending_question_ids"] = ["question-01"]
...
def test_content_branch_companion_followup_selector_does_not_apply_current_question() -> None:
    question_catalog = {
        "question_order": ["question-01"],
        "question_index": {"question-01": _age_question()},
    }
    graph_state = create_graph_state(
        session_id="session-selector-companion-guard-branch",
        channel="grpc",
        quiz_mode="dynamic",
        question_catalog=question_catalog,
        language_preference="zh-CN",
